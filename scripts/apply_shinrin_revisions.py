...
s = s.replace(
    "Tae's additional skills, the Shinrin ruling-guild name, the life-burning poison name, Sigrun's Domain, and the new light/darkness unranked character remain approval-gated until selected.",
...
old = """## 7. Yun Shizhen Goes Missing
...
"""
new = """## 7. Yun Shizhen Goes Missing — And Returns to Isgard Dying
...
old = """### Working name options — NOT LOCKED
...
start = s.index('## 12. New Unranked Light/Darkness Martial Artist — Design Options')
end = s.index('## 13. Remaining Approval Gates Before Rewriting the 200-Chapter Beat Sheet')
replacement = """## 12. New Unranked Light/Darkness Martial Artist — Revised Design Options
