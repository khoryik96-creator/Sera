# S113 post-merge review candidates (TEMP)

Immediate-context residuals: **2**

Mixed pronoun candidates: **5**
...
## Ch482
Adjacent: `aya`(Aya) | Nearby: `aya`(Aya)
...
## Ch481
Nearby: `aya`(Aya), `tsubasa`(Tsubasa), `sera`(Sera), `rhen`(Rhen)
...
## Ch481
Nearby: `tsubasa`(Tsubasa), `rhen`(Rhen)
