# S109 mixed pronoun/voice candidates (TEMP)

## Ch441
Nearby: `rhen`(Rhen), `sera`(Sera), `luweiran`(Lu)
...
## Ch442
Nearby: `rhen`(Rhen), `solveig`(Solveig), `luweiran`(Lu)
...
## Ch442
Nearby: `huo`(Huo), `qin`(Qin), `rhen`(Rhen)
...
## Ch443
Nearby: `rhen`(Rhen), `qin`(Qin), `huo`(Huo)
...
## Ch443
Nearby: `sera`(Sera), `tae`(Tae), `haru`(Haru)
...
## Ch444
Nearby: `yurushi`(Yurushi), `rhen`(Rhen)
...
## Ch447
Nearby: `aya`(Aya), `luo`(Luo), `rhen`(Rhen), `sera`(Sera)
...
## Ch448
Nearby: `rhen`(Rhen), `luo`(Luo), `aya`(Aya)
...
## Ch448
Nearby: `aya`(Aya), `luo`(Luo), `rhen`(Rhen)
...
## Ch450
Nearby: `solveig`(Solveig), `aya`(Aya)
...
## Ch450
Nearby: `tsubasa`(Tsubasa), `aya`(Aya), `sera`(Sera), `rhen`(Rhen)
