...
The result is that **823 quoted lines now have no speaker name.** They
...
|---|---|---|---|
| Season 95 | 194 | `season-095.md` | `FINAL_ARC_SEASON095_PROSE_DRAFT*.md` |
...
| Season 108 | 23 | `season-108.md` | `FINAL_ARC_SEASON108_PROSE_DRAFT*.md` |
...
| Season 111 | 39 | `season-111.md` | `FINAL_ARC_SEASON111_PROSE_DRAFT*.md` |
