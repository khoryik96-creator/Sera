...
export const orchidHierarchy: TeahouseMember[] = [
  {
    ...
    arts: [
      ...
      { name: 'Orchid Dominion', tier: 'Supreme Domain Skill (future)', summary: 'Her future Paragon domain — a one-mile battlefield of pale orchid petals governed by Counter-Bloom. Every hostile offensive commitment exposes a point the attacker has stopped defending; a bloom opens there and Sera chooses the counter that emerges from the opening itself — needle, disabling strike, poison, circulation-severing touch, false attack or concentrated Domain force. The stronger and more complete the attack, the more complete its bloom, while movement, defence, retreat, healing, allies and civilians trigger nothing. It does not suppress cultivation by a fixed amount — its terror is the forced choice between attacking at full power into a stronger counter or entering battle already diminished by restraint — and it continuously presents enemy commitments as one offensive battlefield map. Locked: Sera has not reached Paragon.', status: 'future-locked' },
    ],
