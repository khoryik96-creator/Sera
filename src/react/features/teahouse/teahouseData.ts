...
// relative to the original seasons 1-64 story. Seasons 65-69 now dramatize the
...
export const spoilerNotice =
  'Continuation spoilers. This tab covers the five-years-later "Beneath the Crooked Sign" state. Seasons 65–69 now contain first-draft prose for Years One through the middle of Year Three; Seasons 70–74 remain planned.';
