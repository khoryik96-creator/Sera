...
export const orchidHierarchy: TeahouseMember[] = [
  {
    ...
    arts: [
      ...
      { name: 'The Orchid Blooms Only Once', tier: 'Evolved Supreme', summary: 'Her highest, most personal art: she engineers one perfect, decisive instant and owns it completely, now built during combat rather than prepared in advance. Still unrevealed through this five-year reference; by the final arc she reveals it, building it against Kai Moriyama and landing it on Tsubasa Kurokawa.', status: 'story-locked' },
      { name: 'Orchid Dominion', tier: 'Supreme Domain Skill (future)', summary: 'Her future Paragon domain — a one-mile battlefield of pale orchid petals governed by Counter-Bloom. Every hostile offensive commitment exposes a point the attacker has stopped defending; a bloom opens there and Sera chooses the counter that emerges from the opening itself — needle, disabling strike, poison, circulation-severing touch, false attack or concentrated Domain force. The stronger and more complete the attack, the more complete its bloom, while movement, defence, retreat or healing that carries no hostile offensive commitment triggers nothing, and allies and civilians never trigger a bloom unless they aim hostile offence at Sera or someone under the Domain’s protection. It does not suppress cultivation by a fixed amount — its terror is the forced choice between attacking at full power into a stronger counter or entering battle already diminished by restraint — and it continuously presents enemy commitments as one offensive battlefield map. Through this five-year reference she has not yet reached Paragon, so the Dominion is not yet hers; by the final arc she does reach Peak Paragon and it becomes real, revealed in Season 91 and carried through the northern war.', status: 'future-locked' },
      { name: 'Ten Thousand Blooms', tier: 'Ultimate', summary: 'Her Ultimate, usable only while Orchid Dominion is active — so, like the Dominion, it belongs to the final arc rather than this five-year reference, where she opens it against Tsubasa Kurokawa. Every valid Counter-Bloom already earned across the battlefield can bloom at once, and every fresh hostile commitment during the Ultimate generates its Counter-Bloom immediately, each answerable with a different established Orchid response; unlike a spent finisher it neither collapses nor cancels Orchid Dominion afterward, though its cost is extremely high. It is the battlefield-scale opposite of The Orchid Blooms Only Once.', status: 'future-locked' },
    ],
  ...
  },
  {
    ...
    seat: 'Sepal',
    cultivation: 'High Paragon — the "Iron Horizon Sovereign"; a public Co-#1',
    background:
  ...
  },
  {
    ...
    seat: 'Sepal',
    cultivation: 'High Paragon — same cultivation tier as Tae Muyeon',
    background:
  ...
  },
  {
    ...
    arts: [
      ...
      { name: 'Sanctuary of Petals', tier: 'Supreme (Healing / Protection)', summary: 'The healing art’s permanent evolution (Spring After Snow → Heaven’s Return → Sanctuary of Petals). Its indestructible hemispheric sanctuary reaches a 30-mile radius and up to 100,000 people at once, retaining extreme healing, poison cleansing, internal-energy restoration and reinforcement of healed targets. One catastrophic patient can be restored within seconds, roughly 1–100 severe patients within minutes, and a full 100,000-person restoration within roughly 2–3 days; it still does not resurrect the dead.' },
      ...
      { name: 'Petals in Stasis', tier: 'Supreme', summary: 'His causal-stasis art, distinct from the Ultimate; its stasis identity is unchanged. Final-arc scale: a roughly 10-mile radius in which any martial Domain caught inside active Stasis is neutralized immediately rather than entering a conventional clash — applying to friendly and hostile Domains alike unless Rhen excludes an area, so Sera’s Orchid Dominion cannot casually coexist inside it. Use stays deliberate.' },
      { name: 'Monarch’s Winter Law', tier: 'Supreme Domain Art', summary: 'His post-seclusion second Domain-type art — not a conventional Paragon Dominion, since he stays outside the ranking system. Across up to a 50-mile radius, every hostile cultivator he selects has their entire usable qi reserve condensed into a single frozen petal — one per person regardless of rank, a stronger fighter only yielding a denser petal — so qinggong, reinforcement, active Domains and technique fuel drain away as it forms, with Redline no workaround; the captured petals then answer only to Rhen. Within the same Law he can disintegrate captured petals into Winter Essence, microscopic frost that strips qi coatings, armour, barriers and reinforced weapons, with two finishing modes: Calamity, routing captured qi back through the target’s own motor meridians to break their stance or turn their body against itself (circulation, not thoughts — not mind control), and Quiet Snow, a merciful nonlethal sleep usable on great numbers at once. Targeting is active qi-signature selection, so allies, civilians and the surrendered can be excluded.' },
      { name: 'Petals Beneath a Frozen Moon', tier: 'Ultimate', summary: 'Resolves hostile possibilities into one peaceful, inevitable ending beneath a moon. Once invoked it remains effectively impossible to interrupt; it reaches a 50-mile radius and can strike all or only selected enemies, while within its reach selected allies are healed instantly regardless of number and selected hostile possibilities are resolved instantly. Its graceful character is preserved even at catastrophic scale. Story use is locked — it may exist in reference only, never used in the continuation without direct user approval.', status: 'story-locked' },
    ],
  },
];
