import { DB } from '../../../db';
import { EPISODE_ARCS, TOTAL_CHAPTERS, TOTAL_ARCS, TOTAL_SEASONS } from '../../../episodeMeta';
    ...
    <section className="overview-dashboard">
      <div className="overview-hero">
        <div className="overview-hero__main">
          <div className="overview-hero__meta"><span>THE QUIET REGULAR</span><span>{seasons} seasons</span><span>{TOTAL_CHAPTERS} chapters</span></div>
      ...
      <div className="overview-columns">
        ...
        <section className="overview-panel overview-panel--explore">
          ...
          <div className="overview-explore-grid">
            ...
            <button onClick={() => onOpenSection('chapters')} type="button"><span>Complete story</span><strong>{TOTAL_ARCS} Story Arcs</strong><small>{storyProgress.percent ? `${storyProgress.percent}% opened across ${completedSeasons} completed season${completedSeasons === 1 ? '' : 's'}.` : `Jump directly into all ${TOTAL_SEASONS} seasons.`}</small><b>→</b></button>
          </div>
        </section>
      </div>
    </section>
